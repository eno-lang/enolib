describe 'Expecting fields but getting a list with one item' do
...
describe 'Expecting fields but getting a list with empty lines and multiple items' do
  it 'raises the expected ValidationError' do
    error = nil
...
describe 'Expecting fields but getting a list with two items with comments' do
  it 'raises the expected ValidationError' do
    error = nil
