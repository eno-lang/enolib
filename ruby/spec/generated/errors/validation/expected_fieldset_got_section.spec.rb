describe 'Expecting a fieldset but getting an empty section' do
...
describe 'Expecting a fieldset but getting a section with a field and a list' do
  it 'raises the expected ValidationError' do
    error = nil
...
describe 'Expecting a fieldset but getting a section with subsections' do
  it 'raises the expected ValidationError' do
    error = nil
