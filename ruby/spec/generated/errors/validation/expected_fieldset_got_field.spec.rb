...
describe 'Expecting a fieldset but getting a field' do
...
describe 'Expecting a fieldset but getting a field with continuations' do
  it 'raises the expected ValidationError' do
    input = "field:\n" \
            "| continuation\n" \
            '| continuation'
...
describe 'Expecting a fieldset but getting a field with continuations separated by idle lines' do
  it 'raises the expected ValidationError' do
    input = "field: value\n" \
            "| continuation\n" \
            "| continuation\n" \
