...
describe 'Expecting a section but getting a field with one attribute' do
  it 'raises the expected ValidationError' do
    input = "element:\n" \
            'attribute = value'
...
describe 'Expecting a section but getting a field with empty lines and three attributes' do
  it 'raises the expected ValidationError' do
    input = "element:\n" \
            "\n" \
            "attribute = value\n" \
...
describe 'Expecting a section but getting a field with two attributes with comments' do
  it 'raises the expected ValidationError' do
    input = "element:\n" \
            "> comment\n" \
            "attribute = value\n" \
...
describe 'Expecting a section but getting a field with one item' do
  it 'raises the expected ValidationError' do
    input = "element:\n" \
            '- item'
...
describe 'Expecting a section but getting a field with empty lines and three items' do
  it 'raises the expected ValidationError' do
    input = "element:\n" \
            "\n" \
            "- item\n" \
...
describe 'Expecting a section but getting a field with two items with comments' do
  it 'raises the expected ValidationError' do
    input = "element:\n" \
            "> comment\n" \
            "- item\n" \
...
describe 'Expecting a section but getting a flag' do
  it 'raises the expected ValidationError' do
    input = 'element'
