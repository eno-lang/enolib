...
describe('Expecting lists but getting a field', function() {
...
describe('Expecting lists but getting a field with continuations', function() {
    it('throws the expected ValidationError', function() {
        $error = null;
...
describe('Expecting lists but getting a field with continuations separated by idle lines', function() {
    it('throws the expected ValidationError', function() {
        $error = null;
