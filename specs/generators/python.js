...
import { escapeSingleQuotes, filenamify, interpolatify, quotedPythonMultilineString } from '../../utilities.js';

export function python(specs) {
    const specDirectory = path.resolve('python/tests/generated');
    ...
    for (const spec of specs) {
        ...
        fsExtra.ensureDirSync(testDirectory);
        fsExtra.ensureFileSync(initFilepath);
