...
def test_querying_an_existing_two_line_required_string_comment_from_a_field_with_attributes_produces_the_expected_result():
    input = (">comment\n"
             ">  comment\n"
             "field:\n"
             "attribute = value")
...
def test_querying_an_existing_required_string_comment_with_blank_lines_from_a_field_with_attributes_produces_the_expected_result():
    input = (">\n"
             ">     comment\n"
             ">\n"
             ">   comment\n"
