...
def test_an_embed_with_an_incomplete_embed_operator_in_the_ending_line_raises_the_expected_parseerror():
    error = None
...
def test_an_embed_with_an_edge_case_key_and_missing_space_in_the_ending_line_raises_the_expected_parseerror():
    error = None
