...
def test_querying_the_document_for_a_required_but_missing_flag_raises_the_expected_validationerror():
    error = None
...
def test_querying_a_section_for_a_required_but_missing_flag_raises_the_expected_validationerror():
    error = None
