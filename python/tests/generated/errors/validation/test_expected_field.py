...
def test_expecting_a_field_but_getting_an_empty_section_raises_the_expected_validationerror():
    error = None
...
def test_expecting_a_field_but_getting_a_section_with_a_field_with_a_value_and_a_field_with_two_items_raises_the_expected_validationerror():
    error = None
