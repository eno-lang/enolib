...
def test_expecting_a_field_but_getting_two_fields_with_attributes_comments_empty_lines_and_continuations_raises_the_expected_validationerror():
    error = None
...
def test_expecting_a_field_but_getting_two_fields_with_items_comments_empty_lines_and_continuations_raises_the_expected_validationerror():
    error = None
