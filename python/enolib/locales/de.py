...
expected_single_empty_with_key = lambda key: f"Nur ein einzelnes Leerfeld mit dem Schlüssel '{key}' wurde erwartet."
...
missing_empty_with_key = lambda key: f"Das Leerfeld '{key}' fehlt - falls es angegeben wurde eventuell nach Tippfehlern Ausschau halten und auch die Gross/Kleinschreibung beachten."
