...
describe('Expecting a field but getting a list with empty lines and multiple items', () => {
  it('throws the expected ValidationError', () => {
    let error = null;
...
describe('Expecting a field but getting a list with two items with comments', () => {
  it('throws the expected ValidationError', () => {
    let error = null;
