...
describe('Expecting fields but getting an empty section', () => {
  it('throws the expected ValidationError', () => {
    ...
    try {
      eno.parse(input).fields('section');
    } catch(_error) {
    ...
    const text = `Only fields with the key 'section' were expected, but a section with this key was found.`;
...
describe('Expecting fields but getting a section with a field and a list', () => {
  it('throws the expected ValidationError', () => {
    let error = null;
