...
describe('Expecting lists but getting a field', () => {
...
describe('Expecting lists but getting a field with continuations', () => {
  it('throws the expected ValidationError', () => {
    let error = null;
...
describe('Expecting lists but getting a field with continuations separated by idle lines', () => {
  it('throws the expected ValidationError', () => {
    let error = null;
