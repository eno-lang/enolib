...
describe('Expecting fieldsets but getting an empty section', () => {
  it('throws the expected ValidationError', () => {
    ...
    const text = `Only fieldsets with the key 'section' were expected, but a section with this key was found.`;
...
describe('Expecting fieldsets but getting a section with a field and a list', () => {
  it('throws the expected ValidationError', () => {
    let error = null;
...
describe('Expecting fieldsets but getting a section with subsections', () => {
  it('throws the expected ValidationError', () => {
    let error = null;
