...
module.exports = {
  ...
  expectedEmpty: 'Ein Leerfeld wurde erwartet.',
  ...
  expectedSingleEmpty: 'Nur ein einzelnes Leerfeld wurde erwartet.',
  ...
  missingEmpty: 'Ein einzelnes Leerfeld ist erforderlich - es kann einen beliebigen Schlüssel haben.',
  ...
  expectedSingleEmptyWithKey: (key) => `Nur ein einzelnes Leerfeld mit dem Schlüssel '${key}' wurde erwartet.`,
  ...
  missingEmptyWithKey: (key) => `Das Leerfeld '${key}' fehlt - falls es angegeben wurde eventuell nach Tippfehlern Ausschau halten und auch die Gross/Kleinschreibung beachten.`,
