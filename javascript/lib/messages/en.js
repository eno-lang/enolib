...
exports.en = {
  ...
  expectedSingleEmpty: 'Only a single empty element was expected.',
  ...
  missingEmpty: 'A single empty element is required - it can have any key.',
  ...
  expectedEmptyWithKey: (key) => `An empty element with the key '${key}' was expected.`,
  ...
  expectedSingleEmptyWithKey: (key) => `Only a single empty element with the key '${key}' was expected.`,
  ...
  missingEmptyWithKey: (key) => `The empty element '${key}' is missing - in case it has been specified look for typos and also check for correct capitalization.`,
