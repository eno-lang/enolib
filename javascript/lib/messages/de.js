...
exports.de = {
  ...
  expectedFieldsetEntry: 'Ein Fieldset Eintrag wurde erwartet.',
  expectedFieldsets: 'Nur Fieldsets wurden erwartet.',
  expectedList: 'Eine Liste wurde erwartet.',
  expectedListItem: 'Ein Listen Eintrag wurde erwartet.',
  ...
  expectedSingleEmpty: 'Nur ein einzelnes leeres Element wurde erwartet.',
  ...
  missingEmpty: 'Ein einzelnes leeres Element ist erforderlich - es kann einen beliebigen Schlüssel haben.',
  ...
  expectedEmptyWithKey: (key) => `Ein leeres Element mit dem Schlüssel '${key}' wurde erwartet.`,
  ...
  expectedSingleEmptyWithKey: (key) => `Nur ein einzelnes leeres Element mit dem Schlüssel '${key}' wurde erwartet.`,
  ...
  missingEmptyWithKey: (key) => `Das leere Element '${key}' fehlt - falls es angegeben wurde eventuell nach Tippfehlern Ausschau halten und auch die Gross/Kleinschreibung beachten.`,
